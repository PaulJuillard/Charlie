...
public final class Main {
   ...
   testFindNBest();
    ...
    public static void testPixelAbsoluteError() {
    	...
    	int pixelA = 0b11111111_11111111_11111111;
    	int pixelB = 0b00000000_00000000_00000000; //binary complement to A
    	int pixelC = 0b11111111_11111111_00000000; //one third is binary complement to A
    	
    	double expectedDistanceAB = 1; // A and B binary complement so 100% distance
    	double expectedDistanceAC = 1/3; // A and C have 50% binary distance
    	double expectedDistanceBC = 2/3; // same for B and C
    ...
    public static void testMeanAbsoluteError() {
    	...
    	int pixel1 = 0b11111111_11111111_00000000;
    	int pixel2 = 0b00000000_00000000_00000000; //pixel2 is the complement of pixel1
    	int[][] test_C = new int[][] {{pixel1, pixel1},{pixel1, pixel1}}; // 4 pixel1 ;
    	int[][] test_D = new int[][] {{pixel2 , pixel2},{pixel2 , pixel2}}; // 2 pixel1 and 2 pixel2
    ...
    public static void testDistanceMatrix() {
    	...
    	//=======================================
    	//int [][]distanceTest = new int [distance.length][distance[0].length];
    	//for (int i=0; i<distance.length; ++i) {
    	//for (int j=0; j<distance[0].length; ++j) {
    	//int [i][j]distanceTest = (Integer)distance[i][j];
    	//}}
    	int[] p = Collector.findBest(distance, true);
    	Helper.drawBox(p[0], p[1], onions[0].length, onions.length, food);
    	Helper.show(food, "Found!");
    	//Helper.show(distanceTest, "look at that my man");
    	}
